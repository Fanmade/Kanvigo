 ...
 *
 * Superseded by the {@see ProjectRoles} settings page and no longer mounted
 * anywhere: the editing affordances move into that page's detail pane (KAN-512),
 * at which point this component and its view are removed.
 *
 * @property-read Project $project
 */
class ProjectRolesModal extends Component
{
    ...
    {
        return view('livewire.projects.project-roles-modal');
    }
}
