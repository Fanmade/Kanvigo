...
<body class="bg-zinc-50 font-sans text-zinc-900 antialiased dark:bg-zinc-950 dark:text-zinc-100">
            ...
            <div class="rounded-lg border border-zinc-200 bg-white shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                ...
                <div class="flex flex-col space-y-1.5 p-6">
                    <div class="mb-4 flex items-center justify-center">
                        <!-- Shield Icon -->
                        <svg
                            class="text-brand-600 dark:text-brand-400 h-12 w-12"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                ...
                <div class="space-y-4 p-6 pt-0">
                    ...
                    <div class="rounded-lg border border-zinc-200 bg-zinc-50 p-4 dark:border-zinc-700 dark:bg-zinc-800/50">
                        <p class="mb-2 text-sm text-zinc-500 dark:text-zinc-400">{{ __('Logged in as:') }}</p>
                        ...
                        <div class="space-y-2">
                            ...
                            <label class="flex items-start gap-2">
                                <input
                                    ...
                                    value="all"
                                    form="authorizeForm"
                                    class="accent-brand-600 dark:accent-brand-500 mt-1"
                                    @checked(! $grantRestricts)
                                    data-test="oauth-scope-all"
                                />
                                <span class="text-sm">
                                    {{ __('All projects') }}
                            ...
                            <label class="flex items-start gap-2">
                                <input
                                    ...
                                    class="accent-brand-600 dark:accent-brand-500 mt-1"
                                    @checked($grantRestricts)
                                    data-test="oauth-scope-selected"
                                />
                                <span class="text-sm">
                            ...
                            <ul
                                id="projectChoices"
                                class="{{ $grantRestricts ? '' : 'hidden' }} max-h-40 space-y-2 overflow-y-auto rounded-lg border border-zinc-200 p-3 dark:border-zinc-700"
                            >
                            ...
                            <ul class="space-y-2">
                                @foreach ($scopes as $scope)
                                    <li class="flex items-start gap-2">
                                        <div class="bg-brand-500/10 mt-0.5 rounded-full p-1">
                                            <div class="bg-brand-500 h-1.5 w-1.5 rounded-full"></div>
                                        </div>
                ...
                <div class="flex items-center gap-3 p-6 pt-0">
                    ...
                    <form method="POST" action="{{ route('passport.authorizations.deny') }}" class="flex-1">
                        ...
                        <button
                            type="submit"
                            class="focus-visible:ring-brand-500 inline-flex h-10 w-full items-center justify-center rounded-md border border-zinc-300 bg-white px-4 py-2 text-sm font-medium whitespace-nowrap transition-colors hover:bg-zinc-100 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 dark:border-zinc-600 dark:bg-zinc-900 dark:hover:bg-zinc-800 dark:focus-visible:ring-offset-zinc-900"
                        >
                            <svg
                                class="mr-2 h-4 w-4"
                                stroke="currentColor"
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            class="focus-visible:ring-brand-500 bg-brand-600 hover:bg-brand-500 dark:bg-brand-500 dark:hover:bg-brand-400 inline-flex h-10 w-full items-center justify-center rounded-md px-4 py-2 text-sm font-medium whitespace-nowrap text-white transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-offset-zinc-900"
                            id="authorizeButton"
                        >
                            ...
                            <svg
                                id="loadingSpinner"
                                class="mr-3 -ml-1 hidden h-4 w-4 animate-spin text-white"
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 24 24"
                            >
