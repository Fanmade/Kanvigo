...
<html
    ...
    @class(['dark', 'full-width' => auth()->user()?->preference('full_width', false)])
>
            ...
            <flux:sidebar.nav>
                @can('invite-users')
                    <flux:sidebar.item
                        ...
                        :current="request()->routeIs('invitations.create')"
                        wire:navigate
                    >
                        {{ __('Invite user') }}
                    </flux:sidebar.item>
                ...
                @can('manage-users')
                    <flux:sidebar.item
                        ...
                        wire:navigate
                        data-test="nav-user-administration"
                    >
        ...
        (function () {
            try {
                if (
                    ...
                    document
                        .querySelector('[data-flux-sidebar]')
