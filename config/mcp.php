...
return [
    ...
    */
    ...
    'redirect_domains' => [
        // Claude (Desktop & web) registers its OAuth client dynamically and
        // redirects back to claude.ai / claude.com. Localhost is allowed for
        // local testing tools such as the MCP Inspector.
        'https://claude.ai',
        'https://claude.com',
        'http://localhost',
    ],
