...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'The public REST API for Kanvigo. Manage projects, tasks and comments programmatically. Authenticate with a personal access token (created under Settings → API tokens) sent as a Bearer token; read tokens may call the GET endpoints, write tokens may also create and update.',
    ],
